...
function showFirstAndLast(arr){
    const newArr = [];
     arr.forEach(function(val){
        ...
        // for(let i = 0; i < arr.length; i++){
        //     if(i === 0){
        //         newArr[i] = val[i] + val[val.length - 1];
...
/*
Write a function called addKeyAndValue which accepts an array of objects, a key, and a value and returns the array passed to the function with the new
...
the vowel and the values as the number of times the vowel appears in the string. This function should be case
...
function vowelCount(str){
   ...
   let arr = lowercase.split(""); //converts str to an array
//    console.log(arr);
    arr.forEach(function(val){
        // console.log(val);
...
function extractKey(arr, key){
    ...
    return arr.map(function (val){
        ...
        return val[selectKey];
    })
}

/*
Write a function called extractFullName which accepts an array of objects and returns a new array with the value of the key with a name of "first" and the value of a
...
function extractFullName(arr){
    return arr.map(function (key) {
        let firstLast = `${key.first} ${key.last}`;
...
/*
Write a function called removeVowels which accepts a string and returns a new string with all of the vowels (both uppercased and lowercased) removed. Every
...
function removeVowels(str) {
    ...
    return newArr.filter(function(val){
        //console.log(val);
        return 'aeiou'.indexOf(val) === -1; //this evaluates to true it adds val to new Array and if false it doesn't add anything
    }).join("");
}
